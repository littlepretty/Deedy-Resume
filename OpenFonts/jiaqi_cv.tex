...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Jiaqi}{Yan}{
\urlstyle{same}\href{http://mypages.iit.edu/~jyan31}{mypages.iit.edu/\~jyan31} | Ph.D Candidate @ IIT \\
\href{mailto:littlepretty881203@gmail.com}{littlepretty881203@gmail.com} | 312.888.1642
}
...
\section{Education} 
\subsection{Illinois Inst of Tech}
\descript{Ph.D in Computer Science}
\location{May 2019 | Chicago, IL}
\location{Major GPA: 4.0/4.0}
\sectionsep

\subsection{Beijing Normal Uni}
\descript{ME in Comm Systems}
\location{Jul 2014 | Beijing, China}
...
\subsection{Beijing Normal Uni}
\descript{BS in Elec Engineering}
\location{Jul 2011 | Beijing, China}
\location{Major GPA: 3.7/4.0}
\sectionsep
